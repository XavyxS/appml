...
// Ruta raíz para manejar el callback y verificar que la aplicación está funcionando
app.get('/', async (req, res) => {
    ...
    if (code) {
        ...
        try {
            ...
            return res.status(500).send(`<h1>Error during authorization</h1><p>${error.response ? error.response.data : error.message}</p>`);
        }
